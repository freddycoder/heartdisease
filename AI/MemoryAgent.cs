...
namespace AI
{
    public class MemoryAgent<TDataModel> : IAgent<TDataModel> where TDataModel : IDataModel<int>
    {
        ...
        public MemoryAgent(MemoryAgent<TDataModel> agent)
        {
            _randomEngine = new Random();
        ...
        public MemoryAgent(double[] _vector)
        {
        ...
        {
            Matrix w = new Matrix(1, _vectorLenght);
